<div>
    <div class="flex flex-row justify-between mb-4">
        <x-button wire:click="$dispatch('openModal', { component: 'expenses.product.create-product-modal' })">
            Add product
        </x-button>
    </div>
                    ...
                    <x-tables.data-cell>
                        <x-tables.actions-container>
                            <x-tables.action-modal-button
                                onclick="Livewire.dispatch('openModal', { component: 'expenses.product.view-product-modal', arguments: { productId: {{ $product->id }} }})">
                                <x-icons.view fill="#6b7280"/>
                                <span>View</span>
                            </x-tables.action-modal-button>

                            <x-tables.action-modal-button
                                onclick="Livewire.dispatch('openModal', { component: 'expenses.product.edit-product-modal', arguments: { product: {{ $product }} }})">
                                <x-icons.edit fill="#6b7280"/>
                                <span>Edit</span>
                            </x-tables.action-modal-button>

                            <x-tables.action-modal-button
                                onclick="Livewire.dispatch('openModal', { component: 'expenses.product.delete-product-modal', arguments: { product: {{ $product }} }})">
