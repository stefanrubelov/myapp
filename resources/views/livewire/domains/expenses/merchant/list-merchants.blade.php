<div>
    <div class="flex flex-row justify-between mb-4">
        <x-button wire:click="$dispatch('openModal', { component: 'domains.expenses.merchant.create-merchant-modal' })">
            Add merchant
        </x-button>
    </div>
                    ...
                    <x-tables.data-cell>
                        <x-tables.actions-container>
                            <x-tables.action-modal-button
                                onclick="Livewire.dispatch('openModal', { component: 'domains.expenses.merchant.view-merchant-modal', arguments: { merchantId: {{ $merchant->id }} }})">
                                <x-icons.view fill="#6b7280"/>
                                <span>View</span>
                            </x-tables.action-modal-button>

                            <x-tables.action-modal-button
                                onclick="Livewire.dispatch('openModal', { component: 'domains.expenses.merchant.edit-merchant-modal', arguments: { merchant: {{ $merchant }} }})">
                                <x-icons.edit fill="#6b7280"/>
                                <span>Edit</span>
                            </x-tables.action-modal-button>

                            <x-tables.action-modal-button
                                onclick="Livewire.dispatch('openModal', { component: 'domains.expenses.merchant.delete-merchant-modal', arguments: { merchant: {{ $merchant }} }})">
