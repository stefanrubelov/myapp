...
<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {{$attributes->merge(['class'=> 'w-5 h-5'])}}>
    ...
    <g id="SVGRepo_iconCarrier">
        <path d="M22 15C22 18.7712 22 19.6569 20.8284 20.8284C19.6569 22 17.7712 22 14 22" stroke="{{$fill}}"
              stroke-width="1.5" stroke-linecap="round"></path>
        <path d="M10 2C6.22876 2 4.34315 2 3.17157 3.17157C2 4.34315 2 5.22876 2 9" stroke="{{$fill}}" stroke-width="1.5"
        ...
        <circle cx="12" cy="12" r="2" stroke="{{$fill}}" stroke-width="1.5"></circle>
        <path
